...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2021 at 07:04 PM
...
--
ALTER TABLE `kategori_warna_produk`
  MODIFY `id_warna` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `produk`
  MODIFY `id_produk` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
